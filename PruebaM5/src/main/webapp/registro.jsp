        ...
        <form action="register" method="post"
            ...
            <div class="flex flex-col">
                ...
                <input class="mt-5 rounded-xl p-4 pl-6" placeholder="Peso" type="number" id="weight" name="weight"
                       required/>
                <input class="mt-5 rounded-xl p-4 pl-6" placeholder="Dirección" type="text" id="addressName"
                       name="addressName"
                       required/>
                <input class="mt-5 rounded-xl p-4 pl-6" placeholder="Numeración" type="text" id="addressNumber"
                       name="addressNumber"
                       required/>
                <hr class="mt-5"/>
                <label for="role" class="block mt-5 mb-2 text-sm font-medium text-gray-900 dark:text-white">Selecciona
                    el Rol</label>
                <select id="role" name="role" class="border text-sm rounded-lg block w-full p-2.5">
